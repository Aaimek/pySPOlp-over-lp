...
from webapp.app_utils import create_penalty_params, make_problem_data, run_full_problem  # noqa: E402
    ...
    with st.expander("Section 3 — Problem / Dataset Parameters", expanded=False):
        if mode == "Full recovery problem":
            ...
            dataset_description = {
                ...
                "Simulated toolbox dataset": "Synthetic dataset inspired by the MATLAB toolbox (higher dimension).",
                "Paper-style dataset": "Dataset corresponding to the paper setup.",
            }
